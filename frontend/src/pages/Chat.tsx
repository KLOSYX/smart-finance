                                        ...
                                        <Message.CustomContent>
                                            <Paper
                                                ...
                                                sx={{
                                                    ...
                                                    maxWidth: '95%',
                                                    '& *': { margin: 0, padding: 0 },
                                                    '& p': { mb: '2px', lineHeight: 1.3 },
                                                    '& h1, & h2, & h3': { color: colors.text.primary, mt: '6px', mb: '2px', fontWeight: 600, lineHeight: 1.2 },
                                                    '& h1': { fontSize: '1.05em' },
                                                    '& h2': { fontSize: '1em' },
                                                    '& h3': { fontSize: '0.95em' },
                                                    '& ul, & ol': { pl: '16px', my: '2px' },
                                                    '& li': { lineHeight: 1.3 },
                                                    '& strong': { color: colors.text.primary, fontWeight: 600 },
                                                    '& code': { px: '4px', bgcolor: colors.background.default, borderRadius: '3px', fontSize: '0.85em', color: colors.error.main },
                                                    '& table': { width: '100%', borderCollapse: 'collapse', my: '4px' },
                                                    '& th, & td': { border: `1px solid ${colors.border.main}`, p: '4px', textAlign: 'left' },
