                                        ...
                                        <Message.CustomContent>
                                            <Paper
                                                ...
                                                sx={{
                                                    ...
                                                    maxWidth: '95%',
                                                    '& p': { mb: 0.25, lineHeight: 1.4, '&:last-child': { mb: 0 } },
                                                    '& h1, & h2, & h3': { color: colors.text.primary, mt: 0.75, mb: 0.25, fontWeight: 600, lineHeight: 1.2 },
                                                    '& h1': { fontSize: '1.1em' },
                                                    '& h2': { fontSize: '1.05em' },
                                                    '& h3': { fontSize: '1em' },
                                                    '& ul, & ol': { pl: 2, mb: 0.25, mt: 0.25, listStyle: 'outside' },
                                                    '& li': { mb: 0.1, lineHeight: 1.4 },
                                                    '& strong': { color: colors.text.primary, fontWeight: 600 },
                                                    '& code': { px: 0.5, py: 0.1, bgcolor: colors.background.default, borderRadius: '3px', fontSize: '0.85em', color: colors.error.main },
                                                    '& table': { width: '100%', borderCollapse: 'collapse', my: 0.5 },
                                                    '& th, & td': { border: `1px solid ${colors.border.main}`, p: 0.5, textAlign: 'left' },
